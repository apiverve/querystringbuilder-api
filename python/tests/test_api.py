...
class TestQuerystringbuilderAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = QuerystringbuilderAPIClient(self.api_key)

    @patch('apiverve_querystringbuilder.apiClient.requests.get')
