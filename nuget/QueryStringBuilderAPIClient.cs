...
namespace APIVerve.API.QueryStringBuilder
{
    ...
    /// <summary>
    /// Client for the QueryStringBuilder API
    /// </summary>
    public class QueryStringBuilderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/querystringbuilder";
        ...
        {
            { "params", new ValidationRule { Type = "object", Required = true } },
            { "encode", new ValidationRule { Type = "boolean", Required = false, Format = "url" } }
        };
        ...
        public QueryStringBuilderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public QueryStringBuilderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public QueryStringBuilderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, QueryStringBuilderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(QueryStringBuilderQueryOptions options)
        {
        ...
        public ResponseObj Execute(QueryStringBuilderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(QueryStringBuilderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(QueryStringBuilderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(QueryStringBuilderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(QueryStringBuilderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(QueryStringBuilderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(QueryStringBuilderQueryOptions options)
        {
