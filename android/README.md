# Query String Builder Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:querystringbuilder-api:1.1.12'
}
```
...
```java
import com.apiverve.querystringbuilder.QueryStringBuilderAPIClient;
import com.apiverve.querystringbuilder.APIResponse;
import com.apiverve.querystringbuilder.APIException;

// Initialize the client
QueryStringBuilderAPIClient client = new QueryStringBuilderAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/querystringbuilder](https://docs.apiverve.com/ref/querystringbuilder)
...
- **Documentation:** [https://docs.apiverve.com/ref/querystringbuilder](https://docs.apiverve.com/ref/querystringbuilder)
- **Issues:** [GitHub Issues](https://github.com/apiverve/querystringbuilder-api/issues)
