...
// Request contains the parameters for the Query String Builder API.
//
// Parameters:
...
type Request struct {
	...
	Encode bool `json:"encode,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"encode": {Type: "boolean", Required: false, Format: "url"},
	}
...
// ResponseData contains the data returned by the Query String Builder API.
