...
{
    class QueryStringBuilderExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/querystringbuilder";

        /// <summary>
        /// Make a POST request to the Query String Builder API
        /// </summary>
        static async Task<JsonDocument> CallQueryStringBuilderAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { params &#x3D; [object Object], encode &#x3D; true };
        ...
        {
            Console.WriteLine("📤 Calling Query String Builder API...\n");

            var result = await CallQueryStringBuilderAPI();
