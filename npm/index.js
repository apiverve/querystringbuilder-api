...
class querystringbuilderWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/querystringbuilder');
        }
        ...
        this.validationRules = {"params":{"type":"object","required":true},"encode":{"type":"boolean","required":false,"format":"url","default":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/querystringbuilder`);
        }
    }
...
module.exports = querystringbuilderWrapper;
